...
<div class="topadcs">
    <a class="fullad" href="/product/" title="免费提供专属办公空间设计解决方案" style="background:url(/uploadfiles/pictures/others/20161201094250_0285.jpg) no-repeat center top;"></a>
</div>
<div class="content">
    <div class="rightl">
                                ...
                                <div class="proviewbox">
                                    <div class="probigshow">
                                        <a class="jqzoom" title="${product.name}">
                                            <img src="${product.thumbnail}" alt="${product.name}" title="${product.name}" onload="jqzooms(this)" onerror="jqzooms(this)" class="js_goods_image_url">
                                        </a>
                                    </div>
														...
														<#if productImage?? && productImage.id gt 0>
															<li class="now">
																<a href="" target="_blank" title="${product.name}">
																	<img title="${product.name}" alt="${product.name}" longdesc="${productImage.image}" src="${productImage.image}" width="60">
																</a>
															</li>
														</#if>
													</#list>
