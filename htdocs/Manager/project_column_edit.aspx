<%@ page language="C#" autoeventwireup="True" enableeventvalidation="false" inherits="NSW.Web.Manager.project_column_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
    ...
    <div class="col_main">
        <div class="add_tile_tab f_cb">
		    <ul class="f_cb addtab_ul addtab_ul_column j_recordCon f_fl">
			    ...
			    <li><span class="sp"><em class="zline1"></em><em class="zline2"></em>方案属性</span></li>
			    ...
			    <li class="li6"><span class="sp"><em class="zline1"></em><em class="zline2"></em>相关方案及资讯</span></li>
		    </ul>						
	    </div>
    </div>
        ...
        <div class="add_cont pad300 j_recordCon_c f_cb">
	        ...
	        <div class="cont1">
		        ...
		        <div class="f_cb f_mt25">
			        ...
			        <div class="add_r f_fl">
				        <div class="f_cb add_sv">
					        <span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtTitle" runat="server" CssClass="com_input clear_word EnterWords CreatePY" data-src='{"pyid":"txtFileName","type":"projectcolumn"}' MaxLength="64"></asp:TextBox><i class="clear_x"></i></span><em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_"></em>			
				        </div>				
			        </div>
		        </div>
                <div class="f_cb f_mt25">
			        ...
			        <div class="add_r f_fl">
				        <div class="f_cb add_sv f_lht27">
		 		        ...
		 		        <radio_control:radio_control runat="server" ID="rurlYes" CssName="f_fl f_db e_radio e_radio2" Text="存在" onclick="initTabCut(1);$('#url_warp').show()" />
                            <span class="clear_bd f_fl p_inp1" id="url_warp"><asp:TextBox ID="txtURL" validtype="url_" tipPosition="top" runat="server" CssClass="com_input clear_word EnterWords" MaxLength="64"></asp:TextBox><i class="clear_x"></i></span>
				        </div>
			        </div>
		        </div>
		        <div class="f_cb f_mt25">
		        ...
		        <div class="f_cb f_mt25">
			        ...
			        <div class="add_r f_fl">
				        <div class="f_cb add_editor ">
                            <NSW:UEditor runat="server" ID="txtShortDesc" Height="200" Directory="Project" />
				        </div>			
			        </div>
		        </div>
                        ...
                        <div id="nsw_list_table" class="attr_list f_mt30">
                            ...
                            <div id="nsw_list_content" >
	                            <div class="t_tr child_1">
                                    <asp:Repeater runat="server" ID="AttributeRPT"><ItemTemplate>
                                    <div class="nsw_parent_tr t_tr">
			                            <div class="nsw_no1 nsw_key_1 t_td"><span class="short_tit f_fl"><%#Eval("Title") %><i class="e_edi1 e_more_edit" data-src='{"title":"修改属性","popup":"ProductAttributeColumn","temp_id":"#temp_id", "updatelist": "#nsw_list_content","oid":"<%#Eval("ID") %>"}'></i></span></div>
			                            <div class="nsw_key_2 t_td"><span class="attr_text"><%#NSW.Admin.Tools.AdminTools.ControlTypes[Eval("ControlType").ToString().ToLower()]%></span></div>
			                            <div class="nsw_key_3 t_td"><span class="attr_color"><%#Eval("TxtValues").ToString().Replace(",","，").Replace(NSW.Admin.Tools.AdminTools.Separate,",").Trim(',') %></span><input type="hidden" value="<%#Eval("ID") %>" name="attrid" /></div>
		    ...
		    <div class="cont1 f_dn">
                <div class="f_cb">
					...
					<div class="add_r f_fl">
						<div class="f_cb">
							<div class="colum_onload f_csp f_fl Upload_Clik"  id="icoUpload" input="hdIco" directory="Project"><i class="colum_icon"></i><p class="f_tac f_lht27">点击上传</p></div>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb">
							<div class="colum_onload f_csp f_fl Upload_Clik" id="photoPathUpload" input="hdPhotopath" directory="Project"><i class="colum_icon"></i><p class="f_tac f_lht27">点击上传</p></div>
				...
				<div class="f_cb f_mt25">
			        ...
			        <div class="add_r f_fl">
				        <div class="f_cb add_sv">
					        <span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtExtendTag" runat="server" CssClass="com_input clear_word EnterWords" MaxLength="100"></asp:TextBox><i class="clear_x"></i></span>
				        </div>			
			        </div>
		        </div>	
            ...
            <div class="cont1 inpage_box f_dn">
                <div class="model_side model_list_normal ">
					...
					<div class="model_box">
                        <iframe src="nvtemps.aspx?type=project&page=nvtemps" frameborder="no" border="0" marginwidth="0" width="100%" height="100%" marginheight="0" scrolling="no" allowtransparency="yes" id="nvtemps" name="nvtemps"></iframe>
					</div>
                    <asp:HiddenField runat="server" ID="hdprojectdiretorie" Value="project01" />
                    <asp:HiddenField runat="server" ID="hdmobileprojectdiretorie" />
				</div>
            </div>
            <!--内页模版 end-->
            ...
            <!--相关方案及资讯-->
		    <div class="cont1 f_dn">
                <SelectRelevant:SelectRelevant ID="RelevantProjects" runat="server" ColumnTypes="Project" ColumnName="关联方案" MColumnName="方案"/>
