<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.Manager.projects, qwt" enableviewstate="false" enableviewstatemac="false" %>
...
<div class="so_bread">
	...
	<div class="advan_posi design_posi form_search">
		...
		<span class="clear_bd s_selt f_fl pt43" id="projectColumn">
		    <select class="pass_faq" style="width:120%;" name="cid">
		...
		<span class="clear_bd f_fl">
		    <input class="com_input clear_word" type="text" placeholder="标题名称" maxlength="15" name="kwd"/>
		    <i class="clear_x"></i>
		</span>
<%--		<label class="com_name f_fl f_mr1 f_ml2">简要描述</label>
		<span class="clear_bd f_fl">
		    <input class="com_input clear_word" type="text" placeholder="简要描述" maxlength="20" name="shortdesc"/>
		    <i class="clear_x"></i>
		</span>--%>
    ...
    <form runat="server">
        ...
        <table class="nsw_pro_list" id="nsw_list_table" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr class="child_1">
                ...
                <td>
                    <span class="editor_warp alertColumn update_ColumnID" data-src='{"action":"alertColumn","editor":"select_editor","source":"#projectColumn","type":"project","value":"<%#Eval("ColumnID") %>","oid":"<%#Eval("id") %>"}'></span>
                </td>
                <td>
                <div class="hd_input" oid="<%#Eval("ID") %>" typename="project" fileColumn="isindex">
                ...
                <td>
                    <div class="hd_input" oid="<%#Eval("ID") %>" typename="project" fileColumn="isCommend">
                ...
                <td>
                    <div class="hd_input" oid="<%#Eval("ID") %>" typename="project" fileColumn="isTop">
                ...
                <td>
                    <div class="hd_input" oid="<%#Eval("ID") %>" typename="project" fileColumn="isBest">
                ...
                <td>
                    <div class="hd_input" oid="<%#Eval("ID") %>" typename="project" fileColumn="Enable">
                ...
                <td><span class="editor_warp" data-src='{"action":"alertOrder","dataType":"number","editor":"input_editor","type":"project","oid":"<%#Eval("ID") %>"}'><%#Eval("OrderID") %></span></td>
                <td>
                ...
                <td class="nsw_cnt_area action_tx">
                    ...
                    <%--<span class="pro_dele editor_warp" data-src='{"action":"delete","editor":"delete_editor","type":"project","oid":"<%#Eval("ID") %>"}'><i></i>删除</span>--%>
                </td>
                <% if (NSW.Mobile.MobileConfig.MEnableMobile == "true"){ %>
                <td class="nsw_cnt_area action_tx">
        ...
        <div class="nsw_tools_bar f_cb">
	        ...
	        <div class="batch_act f_fl f_ml20"><span class="c_act ">批量操作<i class="tri_up f_fr"></i></span>
		        <ul class="batch_dropup list">
                    ...
                    <li class="popUp" data-src='{"popup":"ExtensionClassification","action":"extensionClassification","type":"project"}'>批量添加扩展分类</li>
                    <li class="popUp nobd" data-src='{"popup":"ExtensionClassification","action":"cancelExtensionClassification","type":"project","title":"批量取消扩展分类"}'>取消添加扩展分类</li>
