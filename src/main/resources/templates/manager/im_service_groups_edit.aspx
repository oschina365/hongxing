<%@ page language="C#" autoeventwireup="True" inherits="NSW.Web.manager.im_service_groups_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
	    ...
	    <div class="add_cont pad300 j_recordCon_c f_cb">
            ...
            <div class="cont1">
                ...
                <div class="f_cb f_mt25">
					<label class="add_label f_fl"><span class="f_pdl15">所属子域名</span></label>
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtSite" validtype="domain" runat="server" CssClass="com_input clear_word"></asp:TextBox><i class="clear_x"></i></span>
						</div>
                        <i class="i_shortdesc">该组所属分站子域名，如果属于主站，则留空</i>
					</div>
				</div>
