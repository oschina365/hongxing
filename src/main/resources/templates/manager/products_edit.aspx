<%@ Page Language="C#" AutoEventWireup="True" EnableEventValidation="false" Inherits="NSW.Web.Manager.products_edit, qwt"
    EnableViewState="true" ViewStateEncryptionMode="Never" MaintainScrollPositionOnPostback="true" %>
...
<div class="col_main">
	<div class="add_tile_tab f_cb">
		<ul class="f_cb addtab_ul j_recordCon f_fl">
			<li class="active li1"><span class="sp"><em class="zline1"></em><em class="zline2"></em><i class="red_point">*</i>产品基本信息</span></li>
    ...
    <form id="form1" runat="server" onsubmit="top.refreshList=true;saveAllContent();">
	    <div class="add_cont pad300 j_recordCon_c f_cb">
	        <!-- 产品基本信息 -->
            <div class="cont1">
				<div class="f_cb">
					<label class="add_label f_fl"><i class="red_point">*</i>产品标题名称</label>
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1"><asp:TextBox CssClass="com_input clear_word EnterWords CreatePY" data-src='{"pyid":"txtFileName","type":"product"}' MaxLength="64" ID="txtTitle" runat="server"></asp:TextBox><i class="clear_x"></i></span>
				...
				<div class="f_cb f_mt25">
					<label class="add_label f_fl"><i class="red_point">*</i>所属主要分类</label>
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
...
<%--							<div class="add_sort_btn f_fl f_csp">展开关联分类</div>--%>
                ...
                <div class="RelevantColumn">
                    <RelevantColumn:RelevantColumn ID="RelevantColumn" runat="server" CssName="mt40" ColumnTypes="Product" ColumnName="相关分类" MColumnName="请选择产品分类"/>
                </div>
				...
				<!-- 默认属性 -->
                <div class="f_cb f_mt25" runat="server" id="labAttr" visible="false">
                    <label class="add_label f_fl"><span class="f_pdl15">预设属性</span></label>
                    <div class="add_r f_fl">
                        <asp:Label ID="productAttr" runat="server"></asp:Label>
                    </div>
				</div>
				...
				<div class="f_cb f_mt25">
                  ...
                  <div class="f_cb f_mt25">
			        <label class="add_label f_fl"><span class="f_pdl15">产品尺寸：</span></label>
			        <div class="add_r f_fl">
				        <div class="f_cb add_sv">
					        <span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtCustomFields01" runat="server" CssClass="com_input clear_word EnterWords" MaxLength="100"></asp:TextBox><i class="clear_x"></i></span>
				...
				<div class="f_cb f_mt25">
					<label class="add_label f_fl"><span class="f_pdl15">产品简介录入</span></label>
					<div class="add_r f_fl">
                ...
                <div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
                            <iframe src="nvtemps.aspx?page=detailedpagetemps&type=product" frameborder="no" border="0" marginwidth="0" width="100%" height="100%" marginheight="0" scrolling="no" allowtransparency="yes" id="nvtemps" name="nvtemps"></iframe>
                            <asp:HiddenField ID="hdproductdiretorie" Value="product01" runat="server" />
                            <asp:HiddenField ID="hdmobileproductdiretorie" runat="server" />
						</div>
					</div>
				</div>
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_typeset bord_gray extend_warp" style="width:98%;">
							...
							<NSW:UEditor runat="server" ID="txtContent"  Directory="Product" Types="news"/>
			...
			<div class="cont1 f_dn">
                ...
                <div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="nsw_check_box w80">
                            <span class="ck_box mt5">
                                <asp:CheckBox runat="server" ID="cbxShopUrl" CssClass="dn" onclick="if(this.checked){$('#div_url').css('display','inline-block');}else{$('#div_url').hide();}" />
                            </span>
                            <label class="ck_text">启用</label>
                        </div>
                        <div class="nsw_check_box dn" style="line-height:25px;vertical-align:top;width:60%;" id="div_url">
                            <span class="f_pdl15">启用第三方商城</span>
                            <span class="clear_bd p_inp1 ml10"><asp:TextBox CssClass="com_input clear_word" MaxLength="100" ID="txtShopUrl" validtype="url_" runat="server"></asp:TextBox><i class="clear_x"></i></span>
                        </div>
					</div>
				</div>
                <div class="f_cb f_mt25">
                ...
                <div class="f_cb f_mt25">
                    <label class="add_label f_fl"><span class="f_pdl15">产品推荐星级</span></label>
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
