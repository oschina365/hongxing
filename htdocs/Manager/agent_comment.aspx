<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.Manager.agent_comment, qwt" enableviewstate="false" enableviewstatemac="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="nsw_pro_list" id="nsw_list_table" cellpadding="0" cellspacing="0" width="100%">
            <tr id="Tr1">
                ...
                <th style="width:200px" axis="[SubjectID]">加盟名称</th>
            ...
            <tr class="child_1">
                ...
                <td>
                    <div class="hd_input" oid="<%#Eval("ID") %>" typename="agentcomment" fileColumn="Enable">
                ...
                <td><span class="editor_warp" data-src='{"action":"alertOrder","dataType":"number","editor":"input_editor","type":"agentcomment","oid":"<%#Eval("ID") %>"}'><%#Eval("OrderID") %></span>
                </td>
