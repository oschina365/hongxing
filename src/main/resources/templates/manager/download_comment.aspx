<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.Manager.download_comment, qwt" enableviewstate="false" enableviewstatemac="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="nsw_pro_list" id="nsw_list_table" cellpadding="0" cellspacing="0" width="100%">
            <tr id="Tr1">
                ...
                <th style="width:200px" axis="[SubjectID]">下载名称</th>
