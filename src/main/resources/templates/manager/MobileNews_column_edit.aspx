<%@ page language="C#" autoeventwireup="True" inherits="NSW.Web.Manager.MobileNews_column_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
...
<div class="add_cont pad300 j_recordCon_c f_cb">
    ...
    <div class="cont1 inpage_box f_dn">
        <div class="model_side model_list_normal ">
			...
			<div class="model_box">
                <iframe src="nvtemps.aspx?type=news&page=mobilenvtemps" frameborder="no" border="0" marginwidth="0" width="100%" height="100%" marginheight="0" scrolling="no" allowtransparency="yes" id="nvtemps" name="nvtemps"></iframe>
			</div>
