<%@ page language="C#" autoeventwireup="True" enableeventvalidation="false" enableviewstate="true" maintainscrollpositiononpostback="true" inherits="NSW.Web.Manager.agentModification, qwt" enableviewstatemac="false" %>
...
<form id="form1" runat="server" onsubmit="top.refreshList=true;">
    <div class="f_cb pad020 pro_fast_edit" style=" padding:0 0px 0 20px;">
	    <ul class="pro_fast f_cb">
            <li class="f_cb">
			    <label class="p_name padt5 f_fl">加盟标题</label>
			    <div class="seo_r f_fl">
				    <div class="f_cb">
                        <span class="clear_bd px305 f_fl">
                            <asp:TextBox CssClass="com_input clear_word EnterWords CreatePY" data-src='{"pyid":"txtFileName","type":"agent"}' MaxLength="64" ID="txtTitle" runat="server" _required="true" tips="加盟标题"></asp:TextBox>
                            <i class="clear_x"></i>
                        </span>
			    ...
			    <div class="seo_r f_fl">
				    <div class="f_cb">
                        <span class="clear_bd px305">
                            <asp:TextBox CssClass="com_input clear_word" MaxLength="64" ID="txtFileName" runat="server" _required="true" tips="加盟标题"></asp:TextBox>
		    ...
		    <li class="f_cb f_mt25">
			    ...
			    <div class="seo_r f_fl">
				    <div class="f_cb">
                        <asp:TextBox CssClass="seo_descript" MaxLength="200" ID="txtMetaDescription" runat="server" TextMode="MultiLine" Height="50" style=" resize:none; line-height:20px; padding-top:5px;" temp="{length}/{max_length} 字符"></asp:TextBox>
				    </div>
