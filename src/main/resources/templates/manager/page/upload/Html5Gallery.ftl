...
<body id="uploader" action="Handler/upload.ashx?action=SavePictureHttpPostedFile">
	...
	<div class="acc_cont padlr20 bord_gray f_cb">
		<div style=" overflow-y:auto; overflow-x:hidden; height:380px;">
			...
			<div class="viewlist bord_gray f_mt30">
				<div class="view_tips">预览插入的图片（缩略图限<%=Max %>张），先<font color="red">选择分类</font>后再点击上传</div>
				<div class="view_area">
        ...
        <span class="e_btn1 f_csp uploadBtn" id="ups"><i class="insert_icon"></i><em style=" font-style:normal;">确 定</em></span>
...
<script type="text/javascript">
    ...
    window._MAX_ = <%=Max %>;
    window.smallsize = <%=NVEngine.Tools.NewTools.GetAppWebConfig("smallsize")%> * 1024 * 1024;
</script>
