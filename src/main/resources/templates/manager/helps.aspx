<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.Manager.helps, qwt" enableviewstate="false" enableviewstatemac="false" %>
    ...
    <form runat="server">
        ...
        <table class="nsw_pro_list" id="nsw_list_table" cellpadding="0" cellspacing="0" width="100%">
            <tr id="tabHeader">
                ...
                <th style="width:80px" ><b>PC</b>操作</th>
            ...
            <tr class="child_1">
                ...
                <td>
                    <span class="editor_warp alertColumn update_ColumnID" data-src='{"action":"alertColumn","editor":"select_editor","source":"#helpColumn","type":"help","value":"<%#Eval("ColumnID") %>","oid":"<%#Eval("id") %>"}'></span>
                </td>
                <td>
                <div class="hd_input" oid="<%#Eval("ID") %>" typename="help" fileColumn="isindex">
                ...
                <td>
                    <div class="hd_input" oid="<%#Eval("ID") %>" typename="help" fileColumn="isCommend">
                ...
                <td>
                    <div class="hd_input" oid="<%#Eval("ID") %>" typename="help" fileColumn="isTop">
                ...
                <td>
                    <div class="hd_input" oid="<%#Eval("ID") %>" typename="help" fileColumn="isBest">
                ...
                <td>
                    <div class="hd_input" oid="<%#Eval("ID") %>" typename="help" fileColumn="Enable">
                ...
                <td><span class="editor_warp" data-src='{"action":"alertOrder","dataType":"number","editor":"input_editor","type":"help","oid":"<%#Eval("ID") %>"}'><%#Eval("OrderID") %></span></td>
                <td>
                ...
                <td class="nsw_cnt_area action_tx">
                    ...
                    <%--<span class="pro_dele editor_warp" data-src='{"action":"delete","editor":"delete_editor","type":"help","oid":"<%#Eval("ID") %>"}'><i></i>删除</span>--%>
                </td>
                <% if (NSW.Mobile.MobileConfig.MEnableMobile == "true"){ %>
                <td class="nsw_cnt_area action_tx">
