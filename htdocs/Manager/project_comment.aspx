<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.Manager.project_comment, qwt" enableviewstate="false" enableviewstatemac="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="nsw_pro_list" id="nsw_list_table" cellpadding="0" cellspacing="0" width="100%">
            <tr id="Tr1">
                ...
                <th style="width:200px" axis="[SubjectID]">方案名称</th>
            ...
            <tr class="child_1">
                ...
                <td>
                    <span class="short_tit f_fl"><a href="###" onclick="edit(event,<%#Eval("ID") %>)"><%#GetTitles(Eval("Content"))%></a></span>
                </td>
                <td>
                    <span class="short_tit f_fl"><%#Eval("lastip") %></span>
                </td>
                <td>
                    <span class="short_tit f_fl f_underline"><%#GetModelTitleInfo(Eval("SubjectID").ToString())%></span> 
                </td>
                <td>
                    <span class="short_tit f_fl"><%#GetTitles(Eval("FeedBack"))%></span>
                </td>
                <td>
                    <div class="hd_input" oid="<%#Eval("ID") %>" typename="pjcomment" fileColumn="Enable">
                ...
                <td><span class="editor_warp" data-src='{"action":"alertOrder","dataType":"number","editor":"input_editor","type":"pjcomment","oid":"<%#Eval("ID") %>"}'><%#Eval("OrderID") %></span>
                </td>
