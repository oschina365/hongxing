<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.Manager.agents, qwt" enableviewstate="false" enableviewstatemac="false" %>
...
<div class="so_bread">
	...
	<div class="advan_posi design_posi form_search">
		...
		<span class="clear_bd fast_in s_selt1 f_fl" id="agentColumn">
    ...
    <form runat="server">
        ...
        <table class="nsw_pro_list" id="nsw_list_table" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr class="child_1">
                ...
                <th style="width:30px"><%#Eval("ID") %></th>
                <td>
                ...
                <td>
                    <span class="editor_warp alertColumn update_ColumnID" data-src='{"action":"alertColumn","editor":"select_editor","source":"#agentColumn","type":"agent","value":"<%#Eval("ColumnID") %>","oid":"<%#Eval("id") %>"}'></span>
                </td>
                <td>
                    <div class="hd_input" oid="<%#Eval("ID") %>" typename="agent" fileColumn="Delay">
                ...
                <td>
                    <div class="hd_input" oid="<%#Eval("ID") %>" typename="agent" fileColumn="isCommend">
                ...
                <td>
                    <div class="hd_input" oid="<%#Eval("ID") %>" typename="agent" fileColumn="isTop">
                ...
                <td>
                    <div class="hd_input" oid="<%#Eval("ID") %>" typename="agent" fileColumn="isBest">
                ...
                <td>
                    <div class="hd_input" oid="<%#Eval("ID") %>" typename="agent" fileColumn="Enable">
                ...
                <td><span class="editor_warp" data-src='{"action":"alertOrder","dataType":"number","editor":"input_editor","type":"agent","oid":"<%#Eval("ID") %>"}'><%#Eval("OrderID") %></span></td>
                <td>
                ...
                <td class="nsw_cnt_area action_tx">
                    ...
                    <%--<span class="pro_dele editor_warp" data-src='{"action":"delete","editor":"delete_editor","type":"agent","oid":"<%#Eval("ID") %>"}'><i></i>删除</span>--%>
                </td>
                <% if (NSW.Mobile.MobileConfig.MEnableMobile == "true"){ %>">
                <td class="nsw_cnt_area action_tx">
