<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.Manager.usergroup, qwt" enableviewstate="false" enableviewstatemac="false" %>
    ...
    <form id="Form2" runat="server">
        ...
        <table class="nsw_pro_list" id="nsw_list_table" cellpadding="0" cellspacing="0" width="100%">
            <tr id="tabHeader">
                ...
                <th axis="[Title]" style="width: 200px">
                    标题
                </th>
                <th axis="[ShortDesc]">
                    描述
                ...
                <!--end 表头-->
                <th axis="[Enable]" style="width: 60px">
                    状态
                </th>
            ...
            <tr class="child_1">
                ...
                <td class="tac"><div class="hd_input" oid="<%#Eval("ID") %>" typename="usergroup" fileColumn="Enable">
                ...
                <td class="tac">
                    <a href="###" onclick="edit(event,<%#Eval("ID") %>,'usergroup_perm.aspx')">设置权限</a>
                </td>
            </tr>
