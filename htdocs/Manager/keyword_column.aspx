<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.Manager.keyword_column, qwt" enableviewstate="false" enableviewstatemac="false" %>
...
<%--                <th style="width:50px">ID</th>--%>
            ...
            <tr class="child_1 <%#Eval("ID").ToString().Equals("1")?" dn":"" %>" oid="<%#Eval("ID") %>" parentid="<%#Eval("ParentID") %>">
                ...
                <td class="tac">
                <div class="hd_input" oid="<%#Eval("ID") %>" typename="keywordcolumns" fileColumn="Enable">
