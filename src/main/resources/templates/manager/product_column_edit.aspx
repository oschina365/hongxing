<%@ page language="C#" autoeventwireup="True" enableeventvalidation="false" inherits="NSW.Web.Manager.product_column_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
        ...
        <div class="add_cont pad300 j_recordCon_c f_cb">
	        ...
	        <div class="cont1">
		        ...
		        <div class="f_cb f_mt25">
			        ...
			        <div class="add_r f_fl">
				        <div class="f_cb add_sv">
					        <span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtTitle" runat="server" CssClass="com_input clear_word EnterWords CreatePY" data-src='{"pyid":"txtFileName","type":"productcolumn"}' MaxLength="64"></asp:TextBox><i class="clear_x"></i></span><em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_"></em>			
				        </div>				
			        </div>
		        </div>
                <div class="f_cb f_mt25">
                ...
                <div class="f_cb f_mt25">
			        ...
			        <div class="add_r f_fl">
				        <div class="f_cb add_sv">
					        <span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtDirectory" runat="server" CssClass="com_input clear_word EnterWords" Text="Products" MaxLength="64"></asp:TextBox><i class="clear_x"></i></span><em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_"></em>			
				        </div>				
			        </div>
		        </div>
		        <div class="f_cb f_mt25">
		        ...
		        <div class="f_cb f_mt25">
			        ...
			        <div class="add_r f_fl">
				        <div class="f_cb add_editor ">
                            <NSW:UEditor runat="server" ID="txtShortDesc" Height="200" Directory="Product" />
				        </div>			
			        </div>
		        </div>
            ...
            <div class="cont1 inpage_box f_dn">
                <div class="model_side model_list_normal ">
					...
					<div class="model_box">
                        <iframe src="nvtemps.aspx?type=product&page=nvtemps" frameborder="no" border="0" marginwidth="0" width="100%" height="100%" marginheight="0" scrolling="no" allowtransparency="yes" id="nvtemps" name="nvtemps"></iframe>
					</div>
                    <asp:HiddenField runat="server" ID="hdproductdiretorie" Value="product01" />
                    <asp:HiddenField runat="server" ID="hdmobileproductdiretorie" />
				</div>
            </div>
            <!--内页模版 end-->
