<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.Manager.agent_apply_column, qwt" enableviewstate="false" enableviewstatemac="false" %>
    ...
    <div class="nsw_bread_tit f_cb">
	    ...
	    <div class="advanced_so f_fr form_search">
			<div class="search_so f_fl mr10">
				<input type="text" class="so_text clear_word f_fl" name="kwd" placeholder="标题/描述" />
...
<div class="col_main">
    ...
    <div class="nsw_tools_bar f_cb">
	    <ul class="nsw_check_btns f_fl">
		    ...
		    <li class="f_ml20 column" href="agent_applies.aspx">
