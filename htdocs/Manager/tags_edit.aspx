<%@ page language="C#" autoeventwireup="True" inherits="NSW.Web.Manager.tags_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
...
<div class="col_main one_tab_1">
    <form id="form2" runat="server" onsubmit="top.refreshList=true;">
	    <div class="add_cont pad300 j_recordCon_c f_cb">
            ...
            <div class="cont1">
				<div class="f_cb">
					<label class="add_label f_fl"><i class="red_point">*</i>标签的标题名称</label>
                ...
                <div class="f_cb f_mt25">
                    <label class="add_label f_fl"><span class="f_pdl15">标签的长度</span></label>
                    <div class="add_r f_fl">
                        <div class="f_cb add_sv">
