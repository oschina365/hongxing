				...
				<div class="cont1">
					<div class="f_cb">
						<label class="add_label f_fl">
							<i class="red_point">*</i>对象ID
						</label>
						<div class="add_r f_fl">
							<div class="f_cb add_sv">
								<span class="clear_bd f_fl p_inp1">
									<asp:TextBox CssClass="com_input clear_word onlyNumber EnterWords" ID="txtSubjectID" runat="server"></asp:TextBox>
									<i class="clear_x"></i>
								</span>
							</div>
						</div>
					...
					<div class="f_cb f_mt25">
						<label class="add_label f_fl">
							<span class="f_pdl15">相关新闻</span>
						</label>
						<div class="add_r f_fl">
							<div class="add_short_tit add_typeset_tit f_cb p_inp1">
								<span class="f_fl f_underline">
									<%=GetModelTitleInfo(OBJ==null?"": OBJ.SubjectID.ToString())%>
								</span>
							</div>
						</div>
					</div>
					<div class="f_cb f_mt25">
						<label class="add_label f_fl">
							<span class="f_pdl15">评论者</span>
						</label>
						<div class="add_r f_fl">
							<div class="f_cb add_sv">
								<span class="clear_bd f_fl p_inp1">
									<asp:TextBox CssClass="com_input clear_word EnterWords" runat="server" ID="txtUserName" MaxLength="30" />
								</span>
							</div>
						</div>
					</div>
					<div class="f_cb f_mt25 <%=NSW.Admin.Tools.AdminTools.EnableUsersClass %>">
						<label class="add_label f_fl">
							<span class="f_pdl15">用户ID</span>
						</label>
						<div class="add_r f_fl">
							<div class="f_cb add_sv">
								<span class="clear_bd f_fl p_inp1">
									<asp:TextBox CssClass="com_input clear_word onlyNumber EnterWords" runat="server" ID="txtUserID" MaxLength="4" />
								</span>
							</div>
						</div>
					</div>
					<div class="f_cb f_mt25 dn">
						<label class="add_label f_fl">
							<span class="f_pdl15">评分</span>
						</label>
						<div class="add_r f_fl">
							<div class="f_cb add_sv">
								<div class="set_cbs">
									<span class="clear_bd f_fl p_inp1">
										<asp:TextBox CssClass="com_input clear_word" runat="server" ID="txtIntegral" />
									</span>
								</div>
							</div>
						</div>
					...
					<div class="f_cb f_mt25 dn">
						<label class="add_label f_fl">
							<span class="f_pdl15">IP地址</span>
						</label>
						<div class="add_r f_fl">
							<div class="f_cb add_sv">
								<div class="set_cbs">
									<span class="clear_bd f_fl p_inp1">
										<asp:TextBox CssClass="com_input clear_word" runat="server" ID="txtLastIP" />
									</span>
								</div>
							</div>
						</div>
					...
					<div class="f_cb f_mt25 dn">
						<label class="add_label f_fl">
							<span class="f_pdl15">奖励积分是否已派发</span>
						</label>
						<div class="add_r f_fl">
							<div class="nsw_check_box">
								<span class="ck_box mt5">
					...
					<div class="add_r f_fl">
						...
						<div class="view_btn f_mt30">
							<span class="e_btn1 f_csp fl">
								...
								<asp:Button ID="btnSave" CommandName="save" runat="server" Text="保 存" onclick="btnSubmit_Click" OnClientClick="return ValidateForm(this);" />
							</span>
							<span class="e_btn1 f_csp fl" id="btnDel" runat="server">
								<i class="insert_icon"></i>
								<asp:Button ID="btnDels" CommandName="del" runat="server" Text="删 除" onclick="btnSubmit_Click" />
							</span>
