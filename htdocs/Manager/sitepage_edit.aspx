<%@ page language="C#" autoeventwireup="True" inherits="NSW.Web.Manager.sitepage_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
...
<div class="col_main one_tab_1">
    <form id="form2" runat="server" onsubmit="top.refreshList=true;">
	    <div class="add_cont pad300 j_recordCon_c f_cb">
            ...
            <div class="cont1">
				<div class="f_cb">
					<label class="add_label f_fl"><i class="red_point">*</i>静态网页名称</label>
                ...
                <div class="f_cb f_mt25">
					<label class="add_label f_fl">自定义标题</label>
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtMetaTitle" runat="server" CssClass="com_input clear_word EnterWords" MaxLength="250"></asp:TextBox><i class="clear_x"></i></span>
                            <em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_"></em>
						</div>			
					</div>
				</div>
                 <div class="f_cb f_mt25">
					<label class="add_label f_fl">自定义关键词</label>
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtMetaKeywords" runat="server" CssClass="com_input clear_word EnterWords" MaxLength="250"></asp:TextBox><i class="clear_x"></i></span>
                            <em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_"></em>
						</div>			
					</div>
				</div>
                <div class="f_cb f_mt25">
					<label class="add_label f_fl"><span class="f_pdl15">自定义描述</span></label>
					<div class="add_r f_fl">
						<div class="f_cb add_typeset bord_gray">
                            <asp:TextBox CssClass="text_area tx1" MaxLength="500" ID="txtMetaDescription" runat="server" TextMode="MultiLine"></asp:TextBox>
						</div>
					</div>
				</div>
                <div class="f_cb f_mt25">
					<label class="add_label f_fl">网页地址</label>
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtURL" validtype="relativeurl" tipPosition="top" runat="server" CssClass="com_input clear_word" MaxLength="250"></asp:TextBox><i class="clear_x"></i></span>
						</div>			
					</div>
				</div>
                <div class="f_cb f_mt25">
