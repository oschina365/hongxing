...
<head>
	...
	<title>
		${product.name} - 武汉办公家具|办公桌椅生产厂家厂商报价直销|办公家具定制厂家|武汉红鑫办公家具厂
	</title>
	...
	<style>
		#cs_box {width:120px; height:0px; color:#FFF; background:#54a7ff; position:fixed;
			right:5px; top:100px; border-radius:10px; z-index:1000}
		...
		.cs_btn {width:120px; height:25px; background:#333; margin:0px 10px; border-radius:5px;
			font-size:12px; line-height:25px; color:#FFF; text-align:center; cursor:pointer;}
	</style>
</head>
<body>
<!-- 代码部分begin -->
...
<div class="content">
			...
			<div id="printableview">
							...
							<div class="prodetailsinfo">
								<div class="proviewbox">
									<div class="probigshow">
										<a class="jqzoom" href="${product.banner!''}" title="${product.name}">
				...
				<div class="pright">
					<div class="propar">
						...
						<div class="cps pd_short">${product.desc!''}</div>
				...
				<div class="online" id="tbForm1">
					<h2 id="caigou">采购：<span>${product.name}</span></h2>
					<ul class="clearfix">
						<li class="li01">
						...
						<li class="li04">
							...
							<textarea id="txtContent" class="inp4" rows="" cols="" name="" /></textarea>
						</li>
						<li class="li05">
							<span><em class="red_x">*</em>验证码：</span>
						...
						<li class="li06">
							<input type="button" class="b15 btn1" onclick="submitOrder(this,161)" value="提 交" name="" />
	...
	<div class="leftr">
		...
		<div class="leiblx">
			<div class="tit">联系红鑫家具</div>
			<div class="leftlx">
				<div class="dianh">
					<div class="dianhua">咨询热线：<span>400-678-5198</span></div>
					<p>座机：027-61520188</p>
					<p>手机：182-0718-0187</p>
					<p>邮箱：hongxin@hongxin.com.cn</p>
					<p>光谷展厅：武汉市洪山区光谷大道未来之光6号楼1-3楼</p>
					<p>汉口展厅：武汉市汉口北大道家具CBD五百亩工业园内红鑫家具</p>
				</div>
			</div>
		</div>
	</div>
