<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.Manager.jobs, qwt" enableviewstate="false" enableviewstatemac="false" %>
...
<form id="Form2" runat="server">
    ...
    <div class="advan_posi design_posi form_search">
		...
		<span class="clear_bd fast_in s_selt1 f_fl">
            <select class="pass_faq" name="cid">
                <%=NSW.Admin.Tools.AdminTools.FillColumnData_("<option value='{id}'>{title}</option>","tbjobcolumn")%>
            </select>
    ...
    <div class="col_main">
            ...
            <div class="bd_main_left">
                ...
                <table class="nsw_pro_list" id="nsw_list_table" cellpadding="0" cellspacing="0" width="100%">
                    <tr id="tabHeader">
                        ...
                        <th axis="[Title]">职位名称</th>
                        <th style="width:150px" axis="[EndingTime]">到期时间</th>
                        <th style="width:150px" axis="[ColumnName]">部门</th>
                    ...
                    <tr class="child_1">
                        ...
                        <td class="tac"><%# ((DateTime)Eval("EndingTime")).ToString("yyyy-MM-dd<br />HH:mm:ss") %></td>
        ...
        <RightColumn:RightColumn runat="server" TabName="vw_jobcolumn" OrderBy="OrderID asc,ID asc" />
        <div class="clear"></div>
    </div>
</form>
</body>
