<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.Manager.job_column, qwt" enableviewstate="false" enableviewstatemac="false" %>
    ...
    <form id="Form2" runat="server">
        ...
        <table class="nsw_pro_list" id="nsw_list_table" cellpadding="0" cellspacing="0" width="100%">
            <tr id="tabHeader">
                ...
                <th style="width:250px" axis="[ShowDetail]">默认显示详细</th>
            ...
            <tr class="child_1 <%#Eval("ID").ToString().Equals("1")?" dn":"" %>">
                ...
                <td class="tac">
                <div class="hd_input" oid="<%#Eval("ID") %>" typename="jobcolumns" fileColumn="ShowDetail">
                        <span class="p_show e_lowpoint <%#(bool)Eval("ShowDetail")?" z_lowpoint ":""%> " cur="z_lowpoint"><input  class="hd" type="radio" <%#(bool)Eval("ShowDetail")?"checked=\"checked\"":""%>/><label></label></span>
                    </div></td>
                <td class="tac"><%#Eval( "OrderID")%></td>
                <td class="tac">
                <div class="hd_input" oid="<%#Eval("ID") %>" typename="jobcolumns" fileColumn="Enable">
