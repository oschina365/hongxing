...
<@html title_="武汉办公家具-办公桌椅-红鑫办公室家具定制厂家-办公家具-办公家具厂">
    <head>
        ...
        <link href="Skins/Default/Cresetcommon.css" rel="stylesheet" type="text/css"/>
        <link href="Skins/Default/CIndex.css" rel="stylesheet" type="text/css"/>
        <script src="js/Jquery.js"></script>
        <script>
            $(document).ready(function () {
                $(".khj dl").mouseover(function () {
                    $(this).find("span").show();
                });
                $(".khj dl").mouseout(function () {
                    $(this).find("span").hide();
                });
            });
            $(function () {
                $(".one dl").hover(function () {
                    $(this).addClass('cur');
                }, function () {
                        ...
                        <div class="sxc">
                            ...
                            <div class="zhs">
                                <ul>
                                    ...
                                    <li><a href=""><img src="Skins/Default/Img/index/zh_15.jpg" alt="武汉办公家具定制"/><span>工厂三</span></a>
                                    </li>
                                </ul>
                            </div>
                            <a class="ri" href=""></a>
