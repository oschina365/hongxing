<%@ page language="C#" autoeventwireup="True" enableeventvalidation="false" enableviewstate="true" maintainscrollpositiononpostback="true" inherits="NSW.Web.Manager.projectModification, qwt" enableviewstatemac="false" %>
...
<form id="form1" runat="server" onsubmit="top.refreshList=true;">
    <div class="f_cb pad020 pro_fast_edit" style=" padding:0 0px 0 20px;">
	    <ul class="pro_fast f_cb">
            <li class="f_cb">
			    <label class="p_name padt5 f_fl">方案标题</label>
			    <div class="seo_r f_fl">
				    <div class="f_cb">
                        <span class="clear_bd px305 f_fl">
                            <asp:TextBox CssClass="com_input clear_word EnterWords CreatePY" data-src='{"pyid":"txtFileName","type":"project"}' MaxLength="64" ID="txtTitle" runat="server" _required="true" tips="方案标题"></asp:TextBox>
                            <i class="clear_x"></i>
                        </span>
			    ...
			    <div class="seo_r f_fl">
				    <div class="f_cb">
                        <span class="clear_bd px305">
                            <asp:TextBox CssClass="com_input clear_word" MaxLength="64" ID="txtFileName" runat="server" _required="true" tips="方案标题"></asp:TextBox>
                            <asp:HiddenField runat="server" ID="hidFileName" />
                            <i class="clear_x"></i>
                        </span>
                        <a href="###" class="f_ml10 f_ib f_underline color_orange CheckFile" Source="txtFileName">检查是否存在</a>
                    </div>
			    </div>
		    </li>
		    <li class="f_cb">
