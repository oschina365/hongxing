...
//    this.boxy.css('display', 'none').appendTo(top.document.body || document.body);
...
jQuery.extend(Boxy, {
    ...
    DEFAULTS: {
        ...
        closeText:              '<img src="Skins/Blue/css/boxy/close.gif">',      // text to use for default close link
...
Boxy.prototype = {
    ...
    resize: function(width, height, after) {
        ...
        this.boxy.css({ left: bounds[0], top: bounds[1] <= 0 ? 0 : bounds[1] });
    ...
    tween: function(width, height, after) {
        ...
        var bounds = this._getBoundsForResize(width, height);
        var self = this;
        this.boxy.stop().animate({ left: bounds[0], top: bounds[1] <= 0 ? 0 : bounds[1] });
    ...
    show: function() {
        ...
        if (this.options.modal) {
            ...
            this.modalBlackout = jQuery('<div class="boxy-modal-blackout"></div><iframe class="boxy-modal-blackout"></iframe>')
