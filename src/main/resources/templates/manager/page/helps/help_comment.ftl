        ...
        <form name="form1" method="post" action="help_comment.aspx" id="form1">
            ...
            <div class="nsw_tools_bar f_cb top_nsw_tools_bar" style="background: rgb(255, 255, 255);">
                <ul class="nsw_check_btns f_fl">
                    ...
                    <li class="f_ml20">
                        <span class="span_add" onclick="edit(event)">新建</span>|<a onclick="return BatchOperation();" id="lnkBtnDel" href="javascript:__doPostBack('lnkBtnDel','')">
                            <span>删除</span>
                        </a>|<a onclick="return BatchOperation();" id="lnkBtnDisable" href="javascript:__doPostBack('lnkBtnDisable','')">
                            <span>启用</span>
                        </a>|<a onclick="return BatchOperation();" id="lnkBtnEnable" href="javascript:__doPostBack('lnkBtnEnable','')">
                            <span>禁用</span>
                        </a>|<span class="span_refresh">刷新</span>
                    </li>
                </ul>
