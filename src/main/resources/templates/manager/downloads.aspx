<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.Manager.downloads, qwt" enableviewstate="false" enableviewstatemac="false" %>
...
<div class="col_main">
    ...
    <table class="nsw_pro_list" id="nsw_list_table" cellpadding="0" cellspacing="0" width="100%">
        <tr id="tabHeader">
            ...
            <th axis="[Title]">下载文件标题名称</th>
            <th axis="[DownloadURL]">下载文件路径</th>
        ...
        <tr class="child_1">
            ...
            <td class="tac"><a href="<%#Eval("DownloadURL")%>" target="_blank"><%#Eval("DownloadURL")%></a></td>
            ...
            <td class="tac"><%# ((DateTime)Eval("InputTime")).ToString("yyyy-MM-dd<br />HH:mm:ss") %></td>
        </tr>
