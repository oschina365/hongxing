    ...
    <div class="nsw_tools_bar f_cb">
	    <ul class="nsw_check_btns f_fl">
		    ...
		    <li class="f_ml20 list">
                ...
                <span class="span_add" onclick="edit(event)">新建</span>|<span class="span_refresh">刷新</span>|<span class="popUp" data-src='{"popup":"BatchAddColumnPopUp","action":"BatchAddTags","title":"批量添加","type":"tag","etitle":"标签"}'>批量添加</span>
            </li>
	    </ul>
