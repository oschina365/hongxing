<%@ page language="C#" autoeventwireup="True" inherits="NSW.Web.Manager.usergroup_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
    ...
    <form id="form2" runat="server" onsubmit="top.refreshList=true;">
	    <div class="add_cont pad300 j_recordCon_c f_cb">
            ...
            <div class="cont1 settab_lh18">
				<div class="f_cb">
					<label class="add_label f_fl"><i class="red_point">*</i>用户组名称</label>
                ...
                <div class="f_cb f_mt25">
					<label class="add_label f_fl"><i class="red_point">*</i>标识关键词</label>
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
                ...
                <div class="f_cb f_mt25 dn">
                    <label class="add_label f_fl"><span class="f_pdl15">图片名称</span></label>
                    <div class="add_r f_fl">
                        <div class="f_cb add_sv">
                ...
                <div class="f_cb f_mt25">
                    <label class="add_label f_fl"><span class="f_pdl15">该类别的会员享有的产品折扣</span></label>
                    <div class="add_r f_fl">
                        <div class="f_cb add_sv">
						    <span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtDiscount" runat="server" CssClass="com_input clear_word" Text="1" 
onkeypress="return event.keyCode>=48&&event.keyCode<=57||event.keyCode==46" 
onpaste="return !clipboardData.getData('text').match(/\D/)" 
ondragenter="return false" 
style="ime-mode:Disabled"></asp:TextBox><i class="clear_x"></i></span>
                        </div>
					</div>
                </div>

                <div class="f_cb f_mt25">
                    <label class="add_label f_fl"><span class="f_pdl15">持有权限</span></label>
                    <div class="add_r f_fl">
                        <div class="f_cb add_sv">
						    <span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtpPermIDs" runat="server" CssClass="com_input clear_word" Enabled="false">1</asp:TextBox><i class="clear_x"></i></span>
                        </div>
					</div>
                </div>
            ...
            <div class="f_cb f_mt25">
                ...
                <div class="add_r f_fl">
			        ...
			        <div class="view_btn f_mt30">
                        ...
                        <span class="e_btn1 f_ml35 f_csp fl" runat="server" visible="false"><i class="insert_icon"></i><asp:Button CommandName="del" runat="server" Text="删 除" onclick="btnSubmit_Click" /></span>
                    </div>
                </div>
            </div>
		</div>
