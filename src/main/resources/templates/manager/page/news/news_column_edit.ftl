		...
		<div class="add_cont pad300 j_recordCon_c f_cb">
			...
			<div class="cont1">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1">
								<asp:TextBox ID="txtTitle" runat="server" CssClass="com_input clear_word EnterWords CreatePY" data-src='{"pyid":"txtFileName","type":"newscolumn"}' MaxLength="64"></asp:TextBox>
								<i class="clear_x"></i>
							</span>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1">
								<asp:TextBox ID="txtFileName" runat="server" CssClass="com_input clear_word EnterWords" MaxLength="64"></asp:TextBox>
								<i class="clear_x"></i>
							</span>
							<em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_"></em>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1">
								<asp:TextBox ID="txtDirectory" runat="server" CssClass="com_input clear_word EnterWords" MaxLength="64"></asp:TextBox>
								<i class="clear_x"></i>
							</span>
							<em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_"></em>
						</div>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_sv f_lht27">
							...
							<span class="clear_bd f_fl p_inp1" id="url_warp">
								<asp:TextBox ID="txtURL" validtype="url_" tipPosition="top" runat="server" CssClass="com_input clear_word" MaxLength="64"></asp:TextBox>
								<i class="clear_x"></i>
							</span>
						</div>
					</div>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1">
								<asp:TextBox ID="txtDefaultTag" runat="server" CssClass="com_input clear_word EnterWords" MaxLength="100"></asp:TextBox>
								<i class="clear_x"></i>
							</span>
							<em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_"></em>
				...
				<div class="f_cb f_mt25 dn" id="PictureSizeTips">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1" style="width:50px;">
								<asp:TextBox validtype="number" ID="txtWidth" Text="20" runat="server" CssClass="com_input clear_word" MaxLength="3" Width="50"></asp:TextBox>
								<i class="clear_x"></i>
							</span>
							<span class="f_fl lh27 ml10">X</span>
							<span class="clear_bd f_fl p_inp1 ml10" style="width:50px;">
								<asp:TextBox validtype="number" ID="txtHeight" Text="20" runat="server" CssClass="com_input clear_word" MaxLength="3" Width="50"></asp:TextBox>
								<i class="clear_x"></i>
							</span>
						</div>
						<i class="i_shortdesc">
							<%=NSW.OConfig2.SMTP.GetConfig("PictureSizeTips")%>
						</i>
					</div>
				</div>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_editor ">
							<NSW:UEditor runat="server" ID="txtShortDesc" Height="200" Directory="News" />
						</div>
					</div>
				</div>
			...
			<div class="cont1 seo_settab f_dn">
				<div class="f_cb dn">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1">
								<asp:TextBox CssClass="com_input clear_word EnterWords" MaxLength="64" ID="txtTitleKeyword" runat="server"></asp:TextBox>
								<i class="clear_x"></i>
							</span>
							<em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_"></em>
						</div>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						...
						<div class="f_cb f_mt5 f_lht27">
							<div class="f_fl f_mr10 f_ib_"></div>
			...
			<div class="cont1 f_dn">
				<div class="f_cb">
					...
					<div class="add_r f_fl">
						<div class="f_cb">
							<div class="colum_onload f_csp f_fl Upload_Clik" id="icoUpload" input="hdIco" directory="News">
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb">
							<div class="colum_onload f_csp f_fl Upload_Clik" id="photoPathUpload" input="hdPhotopath" directory="News">
								<i class="colum_icon"></i>
								<p class="f_tac f_lht27">点击上传</p>
							</div>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb">
							<div class="f_cb add_sv">
								<span class="clear_bd f_fl p_inp1">
									<asp:TextBox ID="txtBannerURL" validtype="url_" tipPosition="top" runat="server" CssClass="com_input clear_word EnterWords" MaxLength="100"></asp:TextBox>
									<i class="clear_x"></i>
								</span>
							</div>
						</div>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb">
							<div class="f_cb add_sv">
								<span class="clear_bd f_fl p_inp1">
									<asp:TextBox ID="txtBannerAlt" runat="server" CssClass="com_input clear_word EnterWords" MaxLength="100"></asp:TextBox>
									<i class="clear_x"></i>
								</span>
							</div>
						</div>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb">
							<div class="f_cb add_sv">
								<span class="clear_bd f_fl p_inp1" style=" width:50px;">
									<asp:TextBox ID="txtPageSize" Text="20" runat="server" CssClass="com_input clear_word EnterWords" MaxLength="3" Width="50"></asp:TextBox>
									<i class="clear_x"></i>
								</span>
							</div>
						</div>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb controls_calendar">
							<asp:TextBox CssClass="com_input clear_word calendar_tx f_fl" MaxLength="16" ID="txtInputTime" runat="server"></asp:TextBox>
			...
			<div class="cont1 inpage_box f_dn">
				<div class="model_side model_list_normal ">
					...
					<div class="model_box">
						<iframe src="nvtemps.aspx?type=news&page=nvtemps" frameborder="no" border="0" marginwidth="0" width="100%" height="100%" marginheight="0" scrolling="no" allowtransparency="yes" id="nvtemps" name="nvtemps"></iframe>
					</div>
					<asp:HiddenField runat="server" ID="hdnewsdiretorie" Value="news01" />
					<asp:HiddenField runat="server" ID="hdmobilenewsdiretorie" />
				</div>
				...
				<div class="model_side model_list_normal f_mt30">
					...
					<div class="model_box">
						<iframe src="nvtemps.aspx?type=news&page=detailedpagetemps&input=hdDefaultTemplate&defselect=false&cancel=true&columnid=<%=OID %>" frameborder="no" border="0" marginwidth="0" width="100%" height="100%" marginheight="0" scrolling="no" allowtransparency="yes" id="nvtemps01" name="nvtemps01"></iframe>
					</div>
				...
				<div class="add_r f_fl">
					...
					<div class="view_btn f_mt30">
						<span class="e_btn1 f_csp fl">
							...
							<asp:Button ID="btnSave" CommandName="return" runat="server" Text="保 存" onclick="btnSubmit_Click" OnClientClick="return ValidateForm(this);" />
						</span>
						<span class="e_btn1 f_ml35 f_csp fl" runat="server" id="btnDel">
							<i class="insert_icon"></i>
							<asp:Button ID="Button2" CommandName="del" runat="server" Text="删 除" onclick="btnSubmit_Click" />
						</span>
					</div>
				</div>
			</div>
