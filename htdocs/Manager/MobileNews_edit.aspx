<%@ page language="C#" autoeventwireup="True" inherits="NSW.Web.Manager.MobileNews_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
...
<div class="add_cont pad300 j_recordCon_c f_cb">
    ...
    <div class="cont1">
	    <div class="f_cb">
		    <label class="add_label f_fl">当前新闻标题</label>
	    ...
	    <div class="f_cb f_mt25">
            <label class="add_label f_fl">新闻副标题</label>
            <div class="add_r f_fl">
	            <div class="f_cb add_sv">
        ...
        <div class="f_cb f_mt25">
            ...
            <div class="add_r f_fl">
                <div class="colum_onload f_csp f_fl Upload_Clik" input="imgPhotoPath" id="ThumbnailUpload" directory="<%="/Mobile" + NSW.OConfig.Common.UploadedFolderNews%>">
        ...
        <div class="f_cb f_mt25">
            ...
            <div class="add_r f_fl">
                <div class="f_cb add_sv">
	                <span class="f_fl f_db e_radio radio z_select" cur="z_select">同步PC版图文并茂<span class="dn"><input id="rdoCommentableYes_hdRadioButton" type="radio" name="rdoCommentableYes$hdRadioButton" value="TOPCImg"   onclick="initPC2MC(this,<%=OID %>,'tbNews')" /></span></span>
	                <span class="f_fl f_db e_radio radio f_ml10" cur="z_select">同步PC版纯文字<span class="dn"><input id="Radio1" type="radio" name="rdoCommentableYes$hdRadioButton" value="TOPCFont"  onclick="initPC2MC(this,<%=OID %>,'tbNews')" /></span></span>
	                <span class="f_fl f_db e_radio radio f_ml10" cur="z_select">自定义手机端详细内容<span class="dn"><input id="Radio2" type="radio" name="rdoCommentableYes$hdRadioButton" value="TOPCZi"  onclick="initPC2MC(this,<%=OID %>,'tbNews')" /></span></span>
                </div>			
            </div>
        </div>
    ...
    <div class="cont1 inpage_box f_dn">
        <div class="model_side model_list_normal ">
			...
			<div class="model_box">
                <iframe src="nvtemps.aspx?type=news&page=mobiledetailedpagetemps" frameborder="no" border="0" marginwidth="0" width="100%" height="100%" marginheight="0" scrolling="no" allowtransparency="yes" id="nvtemps" name="nvtemps"></iframe>
			</div>
            <asp:HiddenField runat="server" ID="hdDiretorie" Value="news01" />
