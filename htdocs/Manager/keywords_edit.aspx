<%@ page language="C#" autoeventwireup="True" inherits="NSW.Web.Manager.keywords_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
...
<div class="col_main one_tab_1">
    <form id="form2" runat="server" onsubmit="top.refreshList=true;">
	    <div class="add_cont pad300 j_recordCon_c f_cb">
            ...
            <div class="cont1">
				<div class="f_cb">
					<label class="add_label f_fl"><i class="red_point">*</i>关键词的标题名称</label>
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtTitle" runat="server" CssClass="com_input clear_word" MaxLength="50"></asp:TextBox><i class="clear_x"></i></span>
						</div>			
					</div>
				</div>
                ...
                <div class="f_cb f_mt25 dn">
                    <label class="add_label f_fl"><span class="f_pdl15">模式</span></label>
                    <div class="add_r f_fl">
                        <div class="f_cb add_sv">
						    <span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtMode" runat="server" CssClass="com_input clear_word"></asp:TextBox><i class="clear_x"></i></span>
                        </div>
					</div>
                </div>

                <div class="f_cb f_mt25">
                    <label class="add_label f_fl"><span class="f_pdl15">广告的超链接指向</span></label>
                    <div class="add_r f_fl">
						<div class="f_cb add_sv">
                ...
                <div class="f_cb f_mt25 dn">
                    <label class="add_label f_fl"><span class="f_pdl15">关键词的长度</span></label>
                    <div class="add_r f_fl">
                        <div class="f_cb add_sv">
						    <span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtLen" runat="server" ReadOnly="true" CssClass="com_input clear_word" Enabled="false"></asp:TextBox><i class="clear_x"></i></span>
                        </div>
					</div>
                </div>
            ...
            <div class="f_cb f_mt25">
                ...
                <div class="add_r f_fl">
			        ...
			        <div class="view_btn f_mt30">
                        ...
                        <span class="e_btn1 f_csp fl f_ml35"><i class="insert_icon"></i><asp:Button CommandName="save" runat="server" Text="保 存" onclick="btnSubmit_Click" OnClientClick="return ValidateForm(this);" /></span>
