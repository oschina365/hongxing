<%@ page language="C#" autoeventwireup="True" enableeventvalidation="false" enableviewstate="true" maintainscrollpositiononpostback="true" inherits="NSW.Web.Manager.agents_edit, qwt" enableviewstatemac="false" %>
...
<div class="col_main">
	<div class="add_tile_tab f_cb">
		<ul class="f_cb addtab_ul j_recordCon f_fl">
			<li class="active li1"><span class="sp"><em class="zline1"></em><em class="zline2"></em><i class="red_point">*</i>招商加盟基本信息</span></li>
			...
			<li class="li6"><span class="sp"><em class="zline1"></em><em class="zline2"></em>相关产品和资讯</span></li>
		</ul>						
	</div>
    <form id="form1" runat="server" onsubmit="top.refreshList=true;">
	    <div class="add_cont pad300 j_recordCon_c f_cb">
            ...
            <div class="cont1">
				<div class="f_cb">
					<label class="add_label f_fl"><i class="red_point">*</i>招商加盟标题名称</label>
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1"><asp:TextBox CssClass="com_input clear_word EnterWords CreatePY" data-src='{"pyid":"txtFileName","type":"agent"}' MaxLength="64" ID="txtTitle" runat="server"></asp:TextBox><i class="clear_x"></i></span>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
                            ...
                            <asp:Button runat="server" OnClick="AddColumn" ID="btnColumn"  CssClass="dn" CausesValidation="false" />
						</div>		
					</div>
				</div>
                ...
                <div class="f_cb f_mt25">
                    ...
                    <div class="add_r f_fl">
                        <div class="f_cb add_sv">
                            <div class="colum_onload f_csp f_fl Upload_Clik" input="hdThumbnail" id="ThumbnailUpload" directory="agents">
                ...
                <div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
                            <iframe src="nvtemps.aspx?page=detailedpagetemps&type=agent" frameborder="no" border="0" marginwidth="0" width="100%" height="100%" marginheight="0" scrolling="no" allowtransparency="yes" id="nvtemps" name="nvtemps"></iframe>
                            <asp:HiddenField ID="hdagentdiretorie" Value="agent01" runat="server" />
                            <asp:HiddenField ID="hdmobileagentdiretorie" runat="server" />
						</div>
					</div>
				</div>
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
                        <div style=" width:95%;">
                            <NSW:UEditor runat="server" ID="txtContent"  Directory="Agent"  Types="news"/>
                        </div>
					</div>
				</div>
			</div>
			...
			<div class="cont1 seo_settab f_dn">
                ...
                <div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
                        ...
                        <div class="f_cb f_mt5 f_lht27"><div class="f_fl f_mr10 f_ib_"></div><a href="http://www.nsw88.com/Article/wenzhangluruseoshezh_1.html" target="_blank" class="f_fl f_ml10 f_ib f_underline color_orange f_mr20">不知道怎么填写？</a></div>
					</div>
				</div>
                <div class="f_cb f_mt25">
...
<%--                <div class="f_cb">
					<label class="add_label padt5 f_fl"><span class="f_ldb f_pdl15 f_fs2">简介，招商加盟导读</span></label>
					<div class="add_r f_fl">
						<div class="f_cb add_typeset bord_gray">
                            <asp:TextBox CssClass="text_area tx1" MaxLength="500" ID="txtShortDesc" runat="server" TextMode="MultiLine"></asp:TextBox>
							<div class="add_short_tit add_typeset_tit f_cb"><span class="f_fl f_underline">自动排版</span></div>		
                ...
                <div class="f_cb">
					...
					<div class="add_r f_fl">
						<div class="f_cb f_lht27">
                            <asp:TextBox runat="server" ID="txtAuthor" CssClass="com_input clear_word bor1 writer_bd f_fl EnterWords" MaxLength="20" />
                            <em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_"></em>
                            <div class="msg_btn f_fl f_csp">添加网址</div>
							<div class="msg_content f_dn pt44 f_fl">
								<span class="pd010 f_lht27 f_fl">网址</span>
                                <asp:TextBox runat="server" ID="txtAuthorURL" validtype="url_" tipPosition="top" CssClass="com_input clear_word e_input pt72 f_fl" MaxLength="50" placeholder="http://"  />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb f_lht27">
                            <asp:TextBox runat="server" ID="txtEditor" CssClass="com_input clear_word bor1 writer_bd f_fl EnterWords" MaxLength="20" />
                            <em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_"></em>
                            <div class="msg_btn f_fl f_csp">添加网址</div>
							<div class="msg_content f_dn pt44 f_fl">
								<span class="pd010 f_lht27 f_fl">网址</span>
								<asp:TextBox runat="server" ID="txtEditorURL" validtype="url_" tipPosition="top" CssClass="com_input clear_word e_input pt72 f_fl" MaxLength="50" placeholder="http://"  />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb f_lht27">
                            <asp:TextBox runat="server" ID="txtReffer" CssClass="com_input clear_word bor1 writer_bd f_fl EnterWords" MaxLength="20" />
                            <em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_"></em>
                            <div class="msg_btn f_fl f_csp">添加网址</div>
							<div class="msg_content f_dn pt44 f_fl">
								<span class="pd010 f_lht27 f_fl">网址</span>
                                <asp:TextBox runat="server" ID="txtRefferURL" validtype="url_" tipPosition="top" CssClass="com_input clear_word e_input pt72 f_fl" MaxLength="50" placeholder="http://"  />
							</div>
						</div>
					</div>
				</div>
                ...
                <div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb f_lht27">
							<span class="clear_bd f_fl p_inp1 span_max_w50"><asp:TextBox CssClass="com_input clear_word onlyNumber" Width="40" MaxLength="6" ID="txtHits" validtype="number" runat="server"></asp:TextBox><i class="clear_x"></i></span>
                ...
                <div class="f_cb f_mt25">
                    <label class="add_label f_fl"><span class="f_pdl15">招商加盟推荐星级</span></label>
					<div class="add_r f_fl">
						<div class="f_cb f_lht27">
			...
			<div class="cont1 f_dn">
                <SelectRelevant:SelectRelevant ID="RelevantProducts" runat="server" ColumnTypes="Product" ColumnName="关联产品" MColumnName="产品"/>
                <SelectRelevant:SelectRelevant ID="RelevantAgent" runat="server" ColumnTypes="News" CssName="f_cb mt40" ColumnName="关联资讯" MColumnName="资讯"/>
			</div>
            <!-- 关联招商加盟或服务  end-->
