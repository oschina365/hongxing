<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.Manager.ad_column, qwt" enableviewstate="false" enableviewstatemac="false" %>
...
<div class="so_bread">
    <div class="nsw_bread_tit f_cb">
        <SpanCurrentPosition:SpanCurrentPosition runat="server" ID="cur"/>
