<%@ page language="C#" autoeventwireup="True" inherits="NSW.Web.Manager.product_comment_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
				...
				<div class="f_cb">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1"><asp:TextBox CssClass="com_input clear_word onlyNumber EnterWords" MaxLength="4" ID="txtSubjectID" runat="server"></asp:TextBox><i class="clear_x"></i></span>
						</div>			
					</div>
				</div>
                
				<div class="f_cb f_mt25">
					<label class="add_label f_fl"><span class="f_pdl15">相关产品</span></label>
                    <div class="add_r f_fl">
