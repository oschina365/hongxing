<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.Manager.nvcontrols, qwt" enableviewstate="false" enableviewstatemac="false" %>
	    ...
	    <div class="advanced_so f_fr form_search">
            <span class="clear_bd s_selt f_fl mr10 w140">
                <select id="ddlFields" class="pass_faq pl5">
                    <option value="[ShortDesc]">标记</option>
                    <option value="[ShortDesc]">简要描述</option>
                </select>
...
<%--                <th style="width:50px">ID</th>--%>
                <th style="width:200px" axis="[Title]">标题</th>
                <th style="width:50px" axis="[Title]">标记</th>
                <th style="width:100px">缩略图</th>
                <th style="width:120px" axis="[ShortDesc]">描述</th>
