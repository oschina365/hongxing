<%@ page language="C#" autoeventwireup="True" inherits="NSW.Web.Manager.usergroup_permission_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
	    ...
	    <div class="add_cont pad300 j_recordCon_c f_cb">
            ...
            <div class="cont1">
                ...
                <div class="f_cb f_mt25">
					<label class="add_label f_fl"><span class="f_pdl15">上级权限</span></label>
					<div class="add_r f_fl set_selects">
						<asp:DropDownList id="ddlPerm" runat="server"></asp:DropDownList>
					</div>
				</div>
