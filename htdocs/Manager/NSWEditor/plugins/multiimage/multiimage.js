...
(function (K) {
    ...
    K.extend(KSWFUpload, {
        init: function (options) {
            ...
            var settings = {
                ...
                upload_start_handler: function (file) {
                    ...
                    var name = K('.ke-name-title', itemDiv).val();
                    name = name || file["name"].replace(file["type"], "").replace("'", "”");
                    self.setPostParams({ name: name });
                ...
                upload_success_handler: function (file, serverData) {
                    ...
                    file.url = data.url;
                    var input = K('.ke-name-title', itemDiv);
        ...
        appendFile: function (file) {
            ...
            // message
            var title = file["name"].replace(file["type"], "").replace("'", "”");
            K('<div class="ke-message">' + self.options.pendingMessage + '</div>').appendTo(statusDiv);
            itemDiv.append('<div class="ke-name"><input name=\"name\" class=\"ke-name-title\" value=\"' + title + '\"/></div>');
...
KindEditor.plugin('multiimage', function (K) {
    ...
    self.clickToolbar(name, function () {
        self.plugin.multiImageDialog({
            clickFn: function (urlList, img_warps) {
                if (urlList.length === 0) {
                    return;
                }
