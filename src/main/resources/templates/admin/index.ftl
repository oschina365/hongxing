	...
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-header header">
			<div class="layui-main mag0">
				<a href="#" class="logo">武汉红鑫家具</a>
				<!-- 显示/隐藏菜单 -->
				<a href="javascript:;" class="seraph hideMenu icon-caidan"></a>
				<!-- 顶级菜单 -->
				<ul class="layui-nav mobileTopLevelMenus" mobile>
					<li class="layui-nav-item" data-menu="contentManagement">
						<a href="javascript:;"><i class="seraph icon-caidan"></i><cite>首页</cite></a>
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" id="userInfo">
						<a href="javascript:;"><img src="../static/admin/images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">hongxin</cite></a>
						<dl class="layui-nav-child">
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a href="/admin/index" class="img" title="我的头像" ><img src="../static/admin/images/face.jpg" class="userAvatar"></a>
				<p>欢迎登录</p>
			</div>
			<!-- 搜索 -->
		...
		<div class="layui-footer footer">
			<p><span>copyright @2022 武汉红鑫家具后台管理系统</span></p>
		</div>
	</div>
