<%@ page language="C#" autoeventwireup="True" enableeventvalidation="false" enableviewstate="true" maintainscrollpositiononpostback="true" inherits="NSW.Web.Manager.news_edit, qwt" enableviewstatemac="false" %>
...
<div class="col_main">
	<div class="add_tile_tab f_cb">
		<ul class="f_cb addtab_ul j_recordCon f_fl">
			<li class="active li1"><span class="sp"><em class="zline1"></em><em class="zline2"></em><i class="red_point">*</i>资讯基本信息</span></li>
            ...
            <div class="cont1">
				<div class="f_cb">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1"><asp:TextBox CssClass="com_input clear_word EnterWords CreatePY" data-src='{"pyid":"txtFileName","type":"news"}' MaxLength="150" ID="txtTitle" runat="server"></asp:TextBox><i class="clear_x"></i></span>
				...
				<div class="f_cb f_mt25">
                 ...
                 <div class="RelevantColumn">
                    <RelevantColumn:RelevantColumn ID="RelevantColumn" runat="server" CssName="mt40" ColumnTypes="News" ColumnName="相关分类" MColumnName="请选择资讯分类"/>
                </div>
                <script type="text/C#" runat="server">
                    public void FillObjectAfter(NSW.Entities.tbNews OBJ) {
                        OBJ.CustomFields01 = RelevantColumn.Value;
                    }
                    public void SetupObjectAfter(NSW.Entities.tbNews OBJ)
                    {
                        RelevantColumn.Value = OBJ.CustomFields01;
                    }
                </script>
                <div class="f_cb f_mt25">
                ...
                <div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
                            <iframe src="nvtemps.aspx?page=detailedpagetemps&type=news" frameborder="no" border="0" marginwidth="0" width="100%" height="100%" marginheight="0" scrolling="no" allowtransparency="yes" id="nvtemps" name="nvtemps"></iframe>
                            <asp:HiddenField ID="hdnewsdiretorie" Value="news01" runat="server" />
                            <asp:HiddenField ID="hdmobilenewsdiretorie" Value="" runat="server" />
						</div>
					</div>
				</div>
				<div class="f_cb f_mt25">
...
<%--                <div class="f_cb">
					<label class="add_label padt5 f_fl"><span class="f_ldb f_pdl15 f_fs2">简介，资讯导读</span></label>
					<div class="add_r f_fl">
						<div class="f_cb add_typeset bord_gray">
                            <asp:TextBox CssClass="text_area tx1" MaxLength="500" ID="txtShortDesc" runat="server" TextMode="MultiLine"></asp:TextBox>
							<div class="add_short_tit add_typeset_tit f_cb"><span class="f_fl f_underline">自动排版</span></div>		
