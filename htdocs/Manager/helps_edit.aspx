<%@ Page Language="C#" AutoEventWireup="True" Inherits="NSW.Web.Manager.help_edit, qwt"
    EnableViewState="true" EnableViewStateMac="false" ViewStateEncryptionMode="Never"
...
<div class="col_main">
	<div class="add_tile_tab f_cb">
		<ul class="f_cb addtab_ul j_recordCon f_fl">
			<li class="active li1"><span class="sp"><em class="zline1"></em><em class="zline2"></em><i class="red_point">*</i>帮助基本信息</span></li>
    ...
    <form id="form1" runat="server" onsubmit="top.refreshList=true;">
	    <div class="add_cont pad300 j_recordCon_c f_cb">
            ...
            <div class="cont1">
				<div class="f_cb">
					<label class="add_label f_fl"><i class="red_point">*</i>帮助标题名称</label>
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1"><asp:TextBox CssClass="com_input clear_word EnterWords CreatePY" data-src='{"pyid":"txtFileName","type":"help"}' MaxLength="64" ID="txtTitle" runat="server"></asp:TextBox><i class="clear_x"></i></span>
              ...
              <div class="f_cb f_mt25">
				<label class="add_label f_fl"><span class="f_pdl15">线下体验店联系电话</span></label>
				<div class="add_r f_fl">
					<span class="clear_bd f_fl p_inp1">
                        <asp:textbox id="txtCustomFields01" runat="server" CssClass="com_input clear_word onlyNumber" reginput="telinfo"></asp:textbox>
                        <i class="clear_x"></i>
                    </span>
				</div>
                 <asp:HiddenField ID="hdOtherField" runat="server" Value="txtCustomFields01"/>
			    </div>
                <div class="f_cb f_mt25">
                ...
                <div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
                            <iframe src="nvtemps.aspx?page=detailedpagetemps&type=help" frameborder="no" border="0" marginwidth="0" width="100%" height="100%" marginheight="0" scrolling="no" allowtransparency="yes" id="nvtemps" name="nvtemps"></iframe>
                            <asp:HiddenField ID="hdhelpdiretorie" Value="help01" runat="server" />
                            <asp:HiddenField ID="hdmobilehelpdiretorie" runat="server" />
						</div>
					</div>
				</div>
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
                        <div style=" width:95%;">
                            <NSW:UEditor runat="server" ID="txtContent"  Directory="Help"  Types="news"/>
                        </div>
					</div>
				</div>
			</div>
...
<%--                <div class="f_cb">
					<label class="add_label padt5 f_fl"><span class="f_ldb f_pdl15 f_fs2">简介，帮助导读</span></label>
					<div class="add_r f_fl">
						<div class="f_cb add_typeset bord_gray">
                            <asp:TextBox CssClass="text_area tx1" MaxLength="500" ID="txtShortDesc" runat="server" TextMode="MultiLine"></asp:TextBox>
							<div class="add_short_tit add_typeset_tit f_cb"><span class="f_fl f_underline">自动排版</span></div>		
...
--%>
                ...
                <div class="f_cb f_mt25">
                    <label class="add_label f_fl"><span class="f_pdl15">帮助推荐星级</span></label>
					<div class="add_r f_fl">
						<div class="f_cb f_lht27">
			...
			<div class="cont1 f_dn">
                ...
                <SelectRelevant:SelectRelevant ID="RelevantHelp" runat="server" ColumnTypes="News" CssName="f_cb mt40" ColumnName="关联资讯" MColumnName="资讯"/>
			</div>
            <!-- 关联帮助或服务  end-->
