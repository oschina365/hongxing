<%@ page language="C#" autoeventwireup="True" inherits="NSW.Web.Manager.download_comment_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
	    ...
	    <div class="add_cont pad300 j_recordCon_c f_cb">
            ...
            <div class="cont1">
				...
				<div class="f_cb f_mt25">
					<label class="add_label f_fl"><span class="f_pdl15">相关下载</span></label>
                    <div class="add_r f_fl">
