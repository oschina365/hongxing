<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.manager.im_service_groups, qwt" enableviewstate="false" enableviewstatemac="false" %>
	        ...
	        <div class="advanced_so f_fr form_search">
                <span class="clear_bd s_selt f_fl mr10 w140">
                    <select id="ddlFields" class="pass_faq pl5">
                        <option value="[Name]">分组名称</th>
                        <option value="[Site]">所属子域名</th>
                    </select>
        ...
        <form id="Form2" runat="server">
            ...
            <table class="nsw_pro_list" id="nsw_list_table" cellpadding="0" cellspacing="0" width="100%">
                <tr id="tabHeader">
                    ...
                    <th axis="[Name]">分组名称</th>
                    <th axis="[Site]">所属子域名</th>
