<%@ page language="C#" autoeventwireup="true" inherits="NSW.Web.Manager.template_column, qwt" enableviewstate="false" enableviewstatemac="false" %>
    ...
    <form id="Form2" runat="server">
        ...
        <table class="nsw_pro_list grouping" id="nsw_list_table" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr class="child_1 <%#Eval("ID").ToString().Equals("1")?" dn":"" %>" oid="<%#Eval("ID") %>" parentid="<%#Eval("ParentID") %>">
                ...
                <td class="tac">
                <div class="hd_input" oid="<%#Eval("ID") %>" typename="templatecolumn" fileColumn="Enable">
