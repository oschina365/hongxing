<%@ page language="C#" autoeventwireup="True" enableeventvalidation="false" inherits="NSW.Web.Manager.news_column_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
        ...
        <div class="add_cont pad300 j_recordCon_c f_cb">
	        ...
	        <div class="cont1">
		        ...
		        <div class="f_cb f_mt25">
			        ...
			        <div class="add_r f_fl">
				        <div class="f_cb add_sv">
					        <span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtTitle" runat="server" CssClass="com_input clear_word EnterWords CreatePY" data-src='{"pyid":"txtFileName","type":"newscolumn"}' MaxLength="64"></asp:TextBox><i class="clear_x"></i></span><em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_"></em>			
				        </div>				
			        </div>
		        </div>
                <div class="f_cb f_mt25">
		    ...
		    <div class="cont1 f_dn">
                <div class="f_cb">
					...
					<div class="add_r f_fl">
						<div class="f_cb">
							<div class="colum_onload f_csp f_fl Upload_Clik"  id="icoUpload" input="hdIco" directory="News"><i class="colum_icon"></i><p class="f_tac f_lht27">点击上传</p></div>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb">
							<div class="colum_onload f_csp f_fl Upload_Clik" id="photoPathUpload" input="hdPhotopath" directory="News"><i class="colum_icon"></i><p class="f_tac f_lht27">点击上传</p></div>
                ...
                <div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb">
                            <div class="f_cb add_sv">
					            <span class="clear_bd f_fl p_inp1" style=" width:50px;"><asp:TextBox ID="txtPageSize" Text="20" runat="server" CssClass="com_input clear_word EnterWords" MaxLength="3" Width="50"></asp:TextBox><i class="clear_x"></i></span>
				            </div>	
						</div>
					</div>
				</div>
