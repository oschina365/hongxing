<%@ page language="C#" autoeventwireup="True" enableeventvalidation="false" inherits="NSW.Web.Manager.help_column_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
        ...
        <div class="add_cont pad300 j_recordCon_c f_cb">
		        ...
		        <div class="f_cb f_mt25">
			        ...
			        <div class="add_r f_fl">
				        <div class="f_cb add_editor ">
                            <NSW:UEditor runat="server" ID="txtShortDesc" Height="200" Directory="Help" />
				        </div>			
			        </div>
		        </div>
		    ...
		    <div class="cont1 f_dn">
                <div class="f_cb">
					...
					<div class="add_r f_fl">
						<div class="f_cb">
							<div class="colum_onload f_csp f_fl Upload_Clik"  id="icoUpload" input="hdIco" directory="Help"><i class="colum_icon"></i><p class="f_tac f_lht27">点击上传</p></div>
				...
				<div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb">
							<div class="colum_onload f_csp f_fl Upload_Clik" id="photoPathUpload" input="hdPhotopath" directory="Help"><i class="colum_icon"></i><p class="f_tac f_lht27">点击上传</p></div>
                ...
                <div class="f_cb f_mt25">
					...
					<div class="add_r f_fl">
						<div class="f_cb">
                            <div class="f_cb add_sv">
					            <span class="clear_bd f_fl p_inp1" style=" width:50px;"><asp:TextBox validtype="number" ID="txtPageSize" Text="20" runat="server" CssClass="com_input clear_word EnterWords" MaxLength="3" Width="50"></asp:TextBox><i class="clear_x"></i></span>
				            </div>
						</div>
					</div>
				</div>
            ...
            <div class="cont1 inpage_box f_dn">
                <div class="model_side model_list_normal ">
                    ...
                    <asp:HiddenField runat="server" ID="hdhelpdiretorie" Value="help01" />
                    <asp:HiddenField runat="server" ID="hdmobilehelpdiretorie" />
				</div>

                 <div class="model_side model_list_normal f_mt30">
					<div class="model_tit"><span class="model_type f_fl"><i></i>详细页模板选择</span></div>
					<div class="model_box">
                        <iframe src="nvtemps.aspx?type=help&page=detailedpagetemps&input=hdDefaultTemplate&defselect=false&cancel=true&columnid=<%=OID %>" frameborder="no" border="0" marginwidth="0" width="100%" height="100%" marginheight="0" scrolling="no" allowtransparency="yes" id="nvtemps01" name="nvtemps01"></iframe>
					</div>
