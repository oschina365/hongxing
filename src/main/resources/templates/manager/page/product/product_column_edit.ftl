		...
		<form name="form2" method="post" action="/manage/product_column_edit_post" id="form2" onsubmit="top.refreshList=true;">
			<div class="add_cont pad300 j_recordCon_c f_cb">
				...
				<div class="cont1 tab_cat_cont" tab_index="0" style="display: block;">
					...
					<div class="f_cb f_mt25">
						...
						<div class="add_r f_fl">
							<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1">
								<input name="txtFileName" type="text" maxlength="64" id="txtFileName" class="com_input clear_word EnterWords validatebox-text validatebox-invalid" _required="true" triggerkeyup="triggerkeyup" _defvalue="" title="">
								<i class="clear_x"></i>
							</span>
								<em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_">0/64字符</em>
					...
					<div class="f_cb f_mt25">
						...
						<div class="add_r f_fl">
							...
							<span class="clear_bd f_fl p_inp1" style="border-color: rgb(170, 170, 170);">
								<input name="txtDirectory" type="text" value="/Products/" maxlength="64" id="txtDirectory" class="com_input clear_word EnterWords validatebox-text" _required="true" style="color: rgb(79, 81, 89); border-color: rgb(170, 170, 170);" triggerkeyup="triggerkeyup" _defvalue="/Products/">
								<i class="clear_x"></i>
							</span>
								<em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_">10/64字符</em>
							</div>
						</div>
					</div>
					<div class="f_cb f_mt25">
				...
				<div class="cont1 else_info f_dn tab_cat_cont" tab_index="2" style="display: none;">
					<div class="f_cb">
						<label class="add_label f_fl">
							<span class="f_pdl15">相同属性</span>
						</label>
						<div class="add_r f_fl">
							<div class="f_cb">
							<span class="f_fl attr_btn create_attr f_mr30 popUp" data-src="{&quot;popup&quot;:&quot;ProductAttributeColumn&quot;,&quot;temp_id&quot;:&quot;#temp_id&quot;, &quot;updatelist&quot;: &quot;#nsw_list_content&quot;}">
								<i></i>新建属性
							</span>
								<span class="f_fl attr_btn importing f_ml15 popUp" data-src="{&quot;popup&quot;:&quot;ImportedProductColumnAttribute&quot;,&quot;temp_id&quot;:&quot;#temp_id&quot;, &quot;updatelist&quot;: &quot;#nsw_list_content&quot;,&quot;column&quot;:&quot;#txtTitle&quot;}">
								<i></i>导 入
							</span>
							</div>
							...
							<div id="nsw_list_table" class="attr_list f_mt30">
								...
								<div class="dn" id="temp_id">
									<div class="nsw_parent_tr t_tr">
										<div class="nsw_no1 nsw_key_1 t_td">
										<span class="short_tit f_fl">{title}<i class="e_edi1 e_more_edit" data-src="{&quot;title&quot;:&quot;修改属性&quot;,&quot;popup&quot;:&quot;ProductAttributeColumn&quot;,&quot;temp_id&quot;:&quot;#temp_id&quot;, &quot;updatelist&quot;: &quot;#nsw_list_content&quot;,&quot;oid&quot;:&quot;{oid}&quot;}"></i>
										</span>
										</div>
										<div class="nsw_key_2 t_td">
											<span class="attr_text">{type}</span>
										</div>
										<div class="nsw_key_3 t_td">
											<span class="attr_color">{values}</span>
											<input type="hidden" name="_attrid_" value="{oid}">
										</div>
										<div class="nsw_tabsort nsw_key_4 t_td">
											<span class="e_up"></span>
											<span class="e_down"></span>
										</div>
										<div class="nsw_key_5 t_td">
											<span class="admin_dele"></span>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="cont1 f_dn tab_cat_cont" tab_index="3" style="display: none;">
					...
					<div class="f_cb f_mt25">
						<label class="add_label padt5 f_fl">
							<span class="f_pdl15">扩展标签</span>
						</label>
						<div class="add_r f_fl">
							<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1">
								<input name="txtExtendTag" type="text" maxlength="100" id="txtExtendTag" class="com_input clear_word EnterWords" triggerkeyup="triggerkeyup" _defvalue="">
								<i class="clear_x"></i>
							</span>
								<em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_">0/100字符</em>
							</div>
					...
					<div class="f_cb f_mt25">
						...
						<div class="add_r f_fl">
							<div class="f_cb controls_calendar">
								<input name="txtInputTime" type="text" value="2022-08-27 18:08:21" maxlength="16" id="txtInputTime" class="com_input clear_word calendar_tx f_fl" readonly="readonly" style="color: rgb(79, 81, 89); border-color: rgb(170, 170, 170);">
