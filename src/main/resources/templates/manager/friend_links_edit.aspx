<%@ page language="C#" autoeventwireup="True" inherits="NSW.Web.Manager.friend_links_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
...
<div class="col_main one_tab_1">
    <form id="form2" runat="server" onsubmit="top.refreshList=true;">
	    <div class="add_cont pad300 j_recordCon_c f_cb">
            ...
            <div class="cont1">
				<div class="f_cb">
					<label class="add_label f_fl"><i class="red_point">*</i>友情链接名称</label>
                ...
                <div class="f_cb f_mt25">
                    <label class="add_label f_fl"><span class="f_pdl15">友情链接的网址</span></label>
                    <div class="add_r f_fl">
						<div class="f_cb add_sv">
						    <span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtURL" validtype="alldomain" tipPosition="top" runat="server" CssClass="com_input clear_word"></asp:TextBox><i class="clear_x"></i></span>
                        </div>
					</div>
                </div>
                ...
                <div class="f_cb f_mt25 dn">
                    ...
                    <div class="add_r f_fl">
                        <div class="f_cb add_sv">
						    <span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtPhotoName" runat="server" ReadOnly="true" CssClass="com_input clear_word"></asp:TextBox><i class="clear_x"></i></span>
                        </div>
					</div>
                </div>
                ...
                <div class="f_cb f_mt25">
                    ...
                    <div class="add_r f_fl">
                        <div class="colum_onload f_csp f_fl Upload_Clik" input="hdThumbnail">
