<%@ page language="C#" autoeventwireup="True" inherits="NSW.Web.Manager.sitemap_column_edit, qwt" enableviewstate="true" enableviewstatemac="false" %>
    ...
    <form id="form2" runat="server" onsubmit="top.refreshList=true;">
	    <div class="add_cont pad300 j_recordCon_c f_cb">
            ...
            <div class="cont1">
				<div class="f_cb">
					...
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
							<span class="clear_bd f_fl p_inp1"><asp:TextBox ID="txtTitle" runat="server" CssClass="com_input clear_word EnterWords"></asp:TextBox><i class="clear_x"></i></span>
                            <em class="inp_tips_gray pd010 f_lht27 f_fl f_ib_"></em>
						</div>			
					</div>
				</div>
                <div class="f_cb f_mt25">
					<label class="add_label f_fl"><span class="f_pdl15">上级目录</span></label>
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
                            <span class="clear_bd s_selt f_fl pt43 f_mr15">
							    <asp:DropDownList ID="ddlTree" CssClass="pass_faq" runat="server"></asp:DropDownList>
                ...
                <div class="f_cb f_mt25">
					<label class="add_label f_fl">栏目超链接</label>
					<div class="add_r f_fl">
						<div class="f_cb add_sv">
                        ...
                        <i class="i_shortdesc">如果是网站的主要导航，则在此填写导航的超链接地址</i>
					</div>
				</div>
                <div class="f_cb f_mt25">
